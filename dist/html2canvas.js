...
var _BezierCurve = __webpack_require__(22);
...
var parseBounds = exports.parseBounds = function parseBounds(node) {
...
var _textTransform = __webpack_require__(13);

var _TextBounds = __webpack_require__(15);
...
var _border = __webpack_require__(7);

var _borderRadius = __webpack_require__(23);
...
var _letterSpacing = __webpack_require__(27);

var _overflow = __webpack_require__(28);

var _padding = __webpack_require__(29);

var _position = __webpack_require__(12);

var _textDecoration = __webpack_require__(8);

var _textShadow = __webpack_require__(30);

var _textTransform = __webpack_require__(13);

var _transform = __webpack_require__(31);

var _visibility = __webpack_require__(32);

var _zIndex = __webpack_require__(33);
    ...
    function NodeContainer(node, parent, imageLoader, index) {
        ...
        if (node.tagName === 'IMG') {
            node.addEventListener('load', function () {
                _this.bounds = (0, _Bounds.parseBounds)(node);
                _this.curvedBounds = (0, _Bounds.parseBoundCurves)(_this.bounds, _this.style.border, _this.style.borderRadius);
            });
        }
        this.image = getImage(node, imageLoader);
        this.bounds = IS_INPUT ? (0, _Input.reformatInputBounds)((0, _Bounds.parseBounds)(node)) : (0, _Bounds.parseBounds)(node);
...
var _punycode = __webpack_require__(34);
...
var getWrapperBounds = function getWrapperBounds(node) {
    ...
    if (parentNode) {
        ...
        var bounds = (0, _Bounds.parseBounds)(wrapper);
            ...
            this.cache[src] = new Promise(function (resolve, reject) {
                ...
                if (_this.options.imageTimeout) {
                    ...
                    xhr.ontimeout = function () {
                        return reject( true ? 'Timed out (' + timeout + 'ms) fetching ' + src : '');
                    };
                }
...
var _NodeParser = __webpack_require__(19);
...
var _CanvasRenderer = __webpack_require__(42);
...
var _ImageLoader = __webpack_require__(17);
...
var _StackingContext = __webpack_require__(20);

var _StackingContext2 = _interopRequireDefault(_StackingContext);

var _NodeContainer = __webpack_require__(11);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(35)(module), __webpack_require__(36)))
...
var _Angle = __webpack_require__(40);
    ...
    _createClass(Logger, [{
        ...
        value: function log() {
            if (window.console && window.console.log) {
                ...
                Function.prototype.bind.call(window.console.log, window.console).apply(window.console, [Date.now() - this.start + 'ms', 'html2canvas:'].concat([].slice.call(args, 0)));
            }
        }
        ...
        value: function error() {
            if (window.console && window.console.error) {
                ...
                Function.prototype.bind.call(window.console.error, window.console).apply(window.console, [Date.now() - this.start + 'ms', 'html2canvas:'].concat([].slice.call(args, 0)));
            }
        }
    }]);
            ...
            var interval = setInterval(function () {
                if (documentClone.body.childNodes.length > 0) {
                    ...
                    if (cloner.clonedReferenceElement instanceof cloneWindow.HTMLElement || cloner.clonedReferenceElement instanceof HTMLElement) {
                        ...
                        reject( true ? 'Error finding the ' + referenceElement.nodeName + ' in the cloned document' : '');
                    }
                }
            }, 50);
        };
